...
public class Sheep extends Herbivore { //Вівця

    public Sheep (Cell cell, int speed, double weight, double foodNeeded) {
        this.cell = cell;
        this.speed = speed;
        this.weight = weight;
...
//        System.out.println("direction " + direction); //візуалізація координат для налаштування пересування
//        System.out.println("step " + step);
//        System.out.println("cell " + cell);
//        System.out.println("cell.getX " + cell.getX());
//        System.out.println("cell.getY " + cell.getY());
        switch (direction) {
            case 0 -> {
                if (cell.getY() > step) {
                    cell.getAnimals().remove(this);
...
//        saturation = saturation * 0.9; //первинний код який не працював - тварини не помирали
